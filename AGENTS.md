...
**클로이 — 요청서 작성 트리거**: Dennis가 "요청서 작성해줘", "요청서 만들어줘" 등 요청서 생성을 지시하면 클로이는 팀 프로토콜에 따라 즉시 요청서를 작성·저장하고 주요 내용을 요약한다.

**앤 — 결과보고서 작성 트리거**: Dennis가 "결과보고서 작성해줘", "결과 정리해줘" 등 결과 정리를 지시하면 앤은 팀 프로토콜에 따라 즉시 결과보고서를 작성·저장하고 주요 내용을 요약한다.
...
**코라 — 결과보고서 작성 트리거**: Dennis가 "결과보고서 작성해줘", "결과 정리해줘" 등 결과 정리를 지시하면 코라는 팀 프로토콜에 따라 즉시 결과보고서를 작성·저장하고 주요 내용을 요약한다.
