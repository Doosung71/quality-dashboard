...
**클로이에게 요청서 작성 트리거 명령 (Dennis → 클로이):**
> 팀 프로토콜에 따라, 요청서를 작성/생성하고, 주요 내용을 정리/요약해줘.

**앤에게 결과보고서 작성 트리거 명령 (Dennis → 앤):**
> 팀 프로토콜에 따라, 결과보고서를 작성/생성하고, 주요 내용을 정리/요약해줘.
...
**코라에게 결과보고서 작성 트리거 명령 (Dennis → 코라):**
> 팀 프로토콜에 따라, 결과보고서를 작성/생성하고, 주요 내용을 정리/요약해줘.
