...
Dennis가 아래 명령을 내리면 클로이는 즉시 팀 프로토콜(`AGENTS.md` §9)에 따라 해당 요청서를 작성·저장하고 주요 내용을 정리·요약하여 보고한다.

| Dennis의 명령 | 클로이의 행동 |
|---|---|
| **"팀 프로토콜에 따라, 요청서를 작성/생성하고, 주요 내용을 정리/요약해줘"** | `docs/reviews/request-*.md` 또는 `docs/research/request-*.md` 생성 후 핵심 항목 요약 출력 |
