                    ...
                    <div key={task.id} className="p-4 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-slate-50 transition-all space-y-2">
                      ...
                      <div className="flex justify-between items-center pt-2 border-t border-slate-100 mt-2">
                        ...
                        <div className="flex gap-2">
                          <button onClick={() => handleLeaderApprove(task.id, "reject")} className="px-2.5 py-1.5 bg-white border border-slate-200 text-rose-600 hover:border-rose-300 font-bold rounded-lg transition-all">반려</button>
                          <button onClick={() => handleLeaderApprove(task.id, "approve")} className="px-3 py-1.5 bg-slate-950 text-white font-bold rounded-lg hover:bg-slate-800 transition-all">승인/리뷰완료</button>
                        </div>
                      </div>
                    </div>
                  ))
